...
.field private static final aVT:Ljava/util/List;
...
.field private static final aVU:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final aVV:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final aVW:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private static final aVX:Ljava/util/Set;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Set",
            "<",
...
.field static final aic:Ljava/util/Map;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/Map",
            "<",
...
# instance fields
.field private final aVY:Lcom/google/firebase/FirebaseOptions;

.field private final aVZ:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.field private final aWc:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private final aWd:Ljava/util/List;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/List",
            "<",
...
.field private aWe:Lcom/google/android/gms/internal/zzans;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aVT:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aVU:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aVV:Ljava/util/List;
    ...
    sput-object v0, Lcom/google/firebase/FirebaseApp;->aVW:Ljava/util/List;

    invoke-static {}, Ljava/util/Collections;->emptySet()Ljava/util/Set;

    move-result-object v0

    sput-object v0, Lcom/google/firebase/FirebaseApp;->aVX:Ljava/util/Set;

    new-instance v0, Ljava/lang/Object;

    invoke-direct {v0}, Ljava/lang/Object;-><init>()V

    sput-object v0, Lcom/google/firebase/FirebaseApp;->zzaox:Ljava/lang/Object;

    new-instance v0, Landroid/support/v4/util/ArrayMap;

    invoke-direct {v0}, Landroid/support/v4/util/ArrayMap;-><init>()V

    sput-object v0, Lcom/google/firebase/FirebaseApp;->aic:Ljava/util/Map;
...
.method protected constructor <init>(Landroid/content/Context;Ljava/lang/String;Lcom/google/firebase/FirebaseOptions;)V
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aVZ:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/atomic/AtomicBoolean;

    invoke-direct {v0}, Ljava/util/concurrent/atomic/AtomicBoolean;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWa:Ljava/util/concurrent/atomic/AtomicBoolean;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWb:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWc:Ljava/util/List;

    new-instance v0, Ljava/util/concurrent/CopyOnWriteArrayList;

    invoke-direct {v0}, Ljava/util/concurrent/CopyOnWriteArrayList;-><init>()V

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWd:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzatc:Landroid/content/Context;
    ...
    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aVY:Lcom/google/firebase/FirebaseOptions;
...
.method public static getApps(Landroid/content/Context;)Ljava/util/List;
    ...
    invoke-static {p0}, Lcom/google/android/gms/internal/zzanr;->zzeu(Landroid/content/Context;)Lcom/google/android/gms/internal/zzanr;

    move-result-object v1

    sget-object v2, Lcom/google/firebase/FirebaseApp;->zzaox:Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/firebase/FirebaseApp;->aic:Ljava/util/Map;
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzanr;->P()Lcom/google/android/gms/internal/zzanr;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzanr;->Q()Ljava/util/Set;

    move-result-object v0

    sget-object v4, Lcom/google/firebase/FirebaseApp;->aic:Ljava/util/Map;
    ...
    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzanr;->zztz(Ljava/lang/String;)Lcom/google/firebase/FirebaseOptions;
...
.method public static getInstance()Lcom/google/firebase/FirebaseApp;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->zzaox:Ljava/lang/Object;
...
.method public static getInstance(Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {p0}, Lcom/google/firebase/FirebaseApp;->zzrq(Ljava/lang/String;)Ljava/lang/String;
    ...
    :cond_13
    invoke-static {}, Lcom/google/firebase/FirebaseApp;->zzcnw()Ljava/util/List;
    ...
    invoke-static {v3}, Lcom/google/android/gms/common/internal/zzx;->zzia(Ljava/lang/String;)Lcom/google/android/gms/common/internal/zzx;

    move-result-object v3

    invoke-virtual {v3, v0}, Lcom/google/android/gms/common/internal/zzx;->zzb(Ljava/lang/Iterable;)Ljava/lang/String;
...
.method public static initializeApp(Landroid/content/Context;Lcom/google/firebase/FirebaseOptions;Ljava/lang/String;)Lcom/google/firebase/FirebaseApp;
    ...
    invoke-static {p0}, Lcom/google/firebase/FirebaseApp;->zzem(Landroid/content/Context;)V

    invoke-static {p2}, Lcom/google/firebase/FirebaseApp;->zzrq(Ljava/lang/String;)Ljava/lang/String;
    ...
    :goto_f
    sget-object v3, Lcom/google/firebase/FirebaseApp;->zzaox:Ljava/lang/Object;
    ...
    monitor-exit v3
    :try_end_51
    .catchall {:try_start_12 .. :try_end_51} :catchall_7b

    invoke-virtual {v1, v0}, Lcom/google/android/gms/internal/zzanr;->zzg(Lcom/google/firebase/FirebaseApp;)V

    const-class v1, Lcom/google/firebase/FirebaseApp;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->aVT:Ljava/util/List;

    invoke-direct {v0, v1, v0, v2}, Lcom/google/firebase/FirebaseApp;->zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V

    invoke-virtual {v0}, Lcom/google/firebase/FirebaseApp;->zzcnu()Z
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aVU:Ljava/util/List;
    ...
    sget-object v3, Lcom/google/firebase/FirebaseApp;->aVV:Ljava/util/List;
...
.method static synthetic zza(Lcom/google/firebase/FirebaseApp;)V
    ...
    invoke-direct {p0}, Lcom/google/firebase/FirebaseApp;->zzcnx()V
...
.method private zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->zzatc:Landroid/content/Context;
    ...
    invoke-static {v0}, Lcom/google/firebase/FirebaseApp$zzc;->zzeo(Landroid/content/Context;)V
    ...
    :try_start_1f
    sget-object v1, Lcom/google/firebase/FirebaseApp;->aVW:Ljava/util/List;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->aVX:Ljava/util/Set;
...
.method static synthetic zzcgx()Ljava/lang/Object;
    ...
    sget-object v0, Lcom/google/firebase/FirebaseApp;->zzaox:Ljava/lang/Object;

    return-object v0
.end method

.method private zzcnt()V
    .registers 3

    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWa:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static zzcnw()Ljava/util/List;
    .registers 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method private zzcnx()V
    .registers 4

    const-class v0, Lcom/google/firebase/FirebaseApp;

    sget-object v1, Lcom/google/firebase/FirebaseApp;->aVT:Ljava/util/List;
    ...
    sget-object v1, Lcom/google/firebase/FirebaseApp;->aVU:Ljava/util/List;

    invoke-direct {p0, v0, p0, v1}, Lcom/google/firebase/FirebaseApp;->zza(Ljava/lang/Class;Ljava/lang/Object;Ljava/lang/Iterable;)V

    const-class v0, Landroid/content/Context;

    iget-object v1, p0, Lcom/google/firebase/FirebaseApp;->zzatc:Landroid/content/Context;

    sget-object v2, Lcom/google/firebase/FirebaseApp;->aVV:Ljava/util/List;
...
.method public static zzcr(Z)V
    ...
    sget-object v2, Lcom/google/firebase/FirebaseApp;->aic:Ljava/util/Map;
    ...
    iget-object v3, v0, Lcom/google/firebase/FirebaseApp;->aVZ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-direct {v0, p0}, Lcom/google/firebase/FirebaseApp;->zzcs(Z)V
...
.method private zzcs(Z)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWc:Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zzb;->zzcr(Z)V
...
.method private static zzem(Landroid/content/Context;)V
    .registers 2
    ...
    invoke-static {v0}, Lcom/google/android/gms/internal/zzanq;->zza(Landroid/app/Application;)V

    :cond_17
    return-void
.end method

.method private static zzrq(Ljava/lang/String;)Ljava/lang/String;
    .registers 2
    .param p0    # Ljava/lang/String;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public getApplicationContext()Landroid/content/Context;
    ...
    invoke-direct {p0}, Lcom/google/firebase/FirebaseApp;->zzcnt()V
...
.method public getOptions()Lcom/google/firebase/FirebaseOptions;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aVY:Lcom/google/firebase/FirebaseOptions;
...
.method public getToken(Z)Lcom/google/android/gms/tasks/Task;
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWe:Lcom/google/android/gms/internal/zzans;
    ...
    invoke-interface {v0, p1}, Lcom/google/android/gms/internal/zzans;->zzct(Z)Lcom/google/android/gms/tasks/Task;
...
.method public setAutomaticResourceManagementEnabled(Z)V
    ...
    iget-object v3, p0, Lcom/google/firebase/FirebaseApp;->aVZ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-static {}, Lcom/google/android/gms/internal/zzanq;->N()Lcom/google/android/gms/internal/zzanq;

    move-result-object v0

    invoke-virtual {v0}, Lcom/google/android/gms/internal/zzanq;->O()Z
    ...
    invoke-direct {p0, v1}, Lcom/google/firebase/FirebaseApp;->zzcs(Z)V
    ...
    invoke-direct {p0, v2}, Lcom/google/firebase/FirebaseApp;->zzcs(Z)V
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lcom/google/firebase/FirebaseApp;->aVY:Lcom/google/firebase/FirebaseOptions;
...
.method public zza(Lcom/google/android/gms/internal/zzans;)V
    .registers 3
    .param p1    # Lcom/google/android/gms/internal/zzans;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    .end param
    ...
    check-cast v0, Lcom/google/android/gms/internal/zzans;

    iput-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWe:Lcom/google/android/gms/internal/zzans;

    return-void
.end method

.method public zza(Lcom/google/android/gms/internal/zzant;)V
    .registers 7
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aWb:Ljava/util/List;
    ...
    invoke-interface {v0, p1}, Lcom/google/firebase/FirebaseApp$zza;->zzb(Lcom/google/android/gms/internal/zzant;)V
...
.method public zza(Lcom/google/firebase/FirebaseApp$zzb;)V
    ...
    iget-object v0, p0, Lcom/google/firebase/FirebaseApp;->aVZ:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    invoke-interface {p1, v0}, Lcom/google/firebase/FirebaseApp$zzb;->zzcr(Z)V
...
.method public zzcnv()Ljava/lang/String;
    .registers 6
